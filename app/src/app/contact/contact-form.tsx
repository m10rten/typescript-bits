          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                <Button
                  nativeButton={false}
                  render={<ExternalLink href="https://github.com/m10rten/typescript-bits/issues/new/choose" />}
                  className="gap-2">
                ...
                <Button
                  nativeButton={false}
                  variant="outline"
                  render={<ExternalLink href="https://github.com/m10rten/typescript-bits/issues" />}
                  className="gap-2">
